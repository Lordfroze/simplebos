...
<div class="content">
        ...
        <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Monthly Expenses for Kolam Barat</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Jumlah Pakan Kolam Barat</span>
                        <span class="info-box-number">{{$jumlahPakanKolamBarat}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Jumlah Ikan Kolam Barat</span>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="info-box bg-blue">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Jumlah Biaya Kolam Barat</span>
                        <span class="info-box-number">Rp {{ number_format($totalBiayaKolamBarat, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
    ...
    <h2>Tabel Perikanan</h1>
        ...
        <div class="mb-2">
            <!-- Delete Seluruh Data Kolam barat -->
            <form action="{{ route('perikanan.kolam_barat.deleteAll') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete all perikanan data for Kolam barat? This action cannot be undone.');">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-danger">Hapus Seluruh Data Kolam Barat</button>
            </form>
        </div>
</div>
