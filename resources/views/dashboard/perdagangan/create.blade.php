@extends('layouts.app')
@section('title')
Tambah Item Perdagangan
@endsection

@section('content')
<div class="content">
    <form method="POST" action="{{url ('/dashboard/perdagangan')}}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_barang" name="nama_barang" value="" placeholder="royco">
        </div>
